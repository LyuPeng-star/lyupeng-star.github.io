    ...
    <main className="min-h-screen bg-slate-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
          BDAI3001: Big Data and AI Applications
        </h1>
        ...
        <div className="space-y-6">
          ...
          <a 
            href="/materials/BDAI3001-App/app-lecture01.pdf" // 示例：假设你的PDF放在 public/materials/ 目录下
            download 
          ...
          >
            <span className="font-medium">Lecture 1: Digital Transformation Strategy for Major Enterprise Brands</span>
